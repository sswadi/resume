...
\small{\item{
              \textbf{Languages \& Frameworks:}{ HTML , CSS , Javascript , React , Next.js , Typescript , Zustand, Shadcn , Tailwind Css , Node.js , Express , MongoDB , GraphQl , Java , DSA , SASS , Bootstrap , Passport.js , EJS} \\ \vspace{2pt}
...
improving overall system reliability.} {\textcolor{white}{Artifical intelligence, tech documentation, Testing}}
