...
\resumeItemListStart
\resumeItem{{\href{https://saltandpepper.vercel.app/}{\textcolor{blue}{Link: }}}Built a responsive thrift storefront using Next.js App Router, leveraging SSR, SSG, \& streaming for fast loads \& SEO optimization.}
...
\resumeItem{Designed accessible, themeable UI components using Tailwind CSS, Shadcn UI, \& Radix, supporting dark/light/system themes}
