...
\begin{center}
  \textbf{\LARGE \scshape Swati S} \\ \vspace{2pt}
   {\normalsize \textit{ Self-taught full-stack dev with ~2 years of experience delivering scalable, responsive web apps. Strong focus on translating design systems into performant user interfaces \& improving user experience through clean, maintainable code \& thoughtful architecture}} \\ \vspace{2pt}
  \small
