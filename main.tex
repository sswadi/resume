...
\begin{center}
  ...
  \normalsize Web Developer | Ex-Marketer turned Techie \\ \vspace{3pt}
  \small
...
\small{\item{
              \textbf{Languages \& Frameworks:}{ HTML , CSS , Javascript , React , Next.js , Typescript , Shadcn , Tailwind Css , Node.js , Express , MongoDB , GraphQl , Java , DSA , SASS , Bootstrap , Passport.js , EJS} \\ \vspace{3pt}
...
\resumeItemListStart
\resumeItem{{\href{https://saltandpepper.vercel.app/}{\textcolor{blue}{Link: }}}Built responsive eCommerce web app using Next.js App Router, React Query, TypeScript, Tailwind CSS, and Shadcn UI}
